"""Generate a comprehensive HTML report for S.H. Raza auction analysis."""
...
# ── Load & filter data ──────────────────────────────────────────────────────
mehta = pd.read_csv('data/raw/lots_raza_clean.csv')
...
<title>S.H. Raza - Auction Market Analysis</title>
<style>
  :root {{
...
<header>
  <h1><span>Sayed Haider Raza</span></h1>
...
<footer>
  S.H. Raza Auction Market Analysis | Data: Christie's ({stats['years_range']}) | Generated with Python + Plotly
</footer>

</body>
</html>"""

with open('raza_report.html', 'w') as f:
    f.write(html)

print("Report written to raza_report.html")
